...
**Stand**: V9.56-a (23.05.2026) — **der zweite Stamm-Pflege-Bogen (Code-Hygiene 2) ist eröffnet**. Erste Sub-Welle: `renderPlayerEquipUI` 213 → 19 Zeilen schlanker Orchestrator + sieben benannte Helfer (Hinweis · Werkzeug · Partition · Rüstung · Markier 59 Z. · Konsumables 52 Z. · Empty-Hint), max 59 Z., median 31 Z. Verhaltensneutral (V9.44-Disziplin): DOM-Reihenfolge + Event-Handler bit-identisch, Playtest grün vor + nach dem Schnitt. Datei +25 Z. Header-Overhead beim Extrahieren. **Was BLEIBT im Bogen**: drei weitere UI-Builder (`renderSoulEditorUI` 232, `renderLibraryUI` 241, `_workshopRenderStatsPanel` 319), dann sieben Kontrollfluss-Funktionen (`fuseWorlds`, `_tickCreatureTaskDirection`, `_voxelChunkGeometry`, `processChatCommand`, `_applyDayNightToScene`, `generateTerrainWithParameters`, `loadState`).
