...
**Stand**: V12.0-e (28.05.2026) — **V12-Genie-Bogen substanziell durch: Three.js r184 + WebGPU-required + V11-Mesh-Pool reaktiviert + V9.95-WebGPU-Compute reaktiviert**. Sieben V12-Sub-Wellen committed (V12.0-diag/vendor.1/2/3/4/a/d/e): r164 hat WebGLNodeBuilder strukturell entfernt → NodeMaterials laufen NUR auf WebGPURenderer, Hot-Swap-Pfad + `rendererKind`-Gates gestrichen (~150 Z. netto-Streichung). r184's „Improve Bind Group Layout cache system" + „compileAsync truly non-blocking" heilen den v160-stale-Buffer-Race strukturell — V10.0-j.j-Memory-Trade obsolet, V11-Mesh-Pool aktiv im Lifecycle, ~500 KB GPU-Heap pro Welt-Wechsel gespart. V9.95-WebGPU-Compute-Pipeline (Mai 2026 als „Vorarbeit für V10+" abgeklemmt) ist reaktiviert als Stufe-2-Fallback im Streaming-Pfad — die V9.95-e-Wurzel (cross-backend mapAsync auf WebGL-Renderer) ist auf r184's WebGPURenderer obsolet. Schöpfer-Browser bestätigt FPS 60+ auf AMD RDNA-3 nach `transformedNormalWorld → normalWorld` Rename. **V12-Bogen-Rest**: V12.0-f-full (MeshToonNodeMaterial-Migration, ~250 Z. erwartete netto-Streichung) + V12.0-g (final Audit) + V12.0-perf (Edit-Cluster-FPS-Heilung als Folge-Welle nach g). Davor: V10.0-Bogen (23 Sub-Wellen, 26-27.05.2026) brachte Three.js r134 → r160 + alle 5 Material-Familien als NodeMaterials; V11.0-Bogen (Mesh-Pool-Foundation, eingefroren in v160) wurde in V12.0-d auf r184 reaktiviert. Volle Chronik in `docs/handover.md`.
