...
**Stand**: V9.86 (25.05.2026) — **Welle Perf-2 ext.a fertig + PR ready-to-merge + Welle Perf-3 als epochaler Bogen vollständig geplant**. PR `claude/epic-babbage-vRHsE` trägt V9.83→V9.86 (CI-Flake-Heilung + Welle Perf-1+2+ext.a), CI ist 4× ✅ grün — bereit zum Merge. **Welle Perf-3 als nächste Welle** (V9.87+, Master-Plan in `docs/performance.md` §4): Schöpfer-Auftrag „die Bibliothek von Alexandria der Neuzeit muss selbst die AAA-Titel alt aussehen lassen — Effizienz, Simplizität, Tiefe in nie dagewesener Synergie". Vier Sub-Wellen: **3.a** Atlas-Strict-Wasser-Gate (Minecraft-Pattern, heilt „Wasser an Strukturen + Bergwänden" strukturell); **3.b** Distance-LOD für ferne Chunks (BotW/Genshin-Pattern, 8× weniger Density-Samples bei >80 m); **3.d** Frustum-priorisiertes Build (sichtbare Chunks zuerst); **3.c** Worker-Migration für Density+Iso (Subnautica/NMS/Astroneer/Vintage-Story-Pattern — der STRUKTURELLE Wurf, alle Spikes weg). Welle Perf-3 zieht die WURZEL der Frame-Drops (synchroner Main-Thread-Build) strukturell weg.

**Davor — V9.86 (25.05.2026)** — Welle Perf-2 ext.a: drei Heilungen nach V9.85-Browser-Audit.
