...
**Stand**: V8.23 (17.05.2026) — Welle 6.X komplett, 8 Audit-Runden nach Schöpfer-Browser-Tests, V8.23 Test-Infrastruktur + Welt-Portal-Konzept-Vision.

## Was es ist

AnazhRealm ist eine 3D-Browser-Sandbox in **einer einzigen Datei** (`anazhRealm.js`, ~25000 Zeilen, Vanilla JS + Three.js + Ammo.js). Drei zentrale Vision-Pfeiler:
...
npm run playtest        # 1879+ Headless-Invarianten (~60s)
npm run audit:strict    # 4 generische Audit-Schichten (~25s, V8.23+)
```
...
| `docs/world-portal.md` | **V8.23 Vision-Anker** — Bibliothek von Alexandria der Vibecode-Ära |
