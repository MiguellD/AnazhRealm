...
**Stand**: V9.50 (22.05.2026) — **Wasser aus der Terrain-Wahrheit**. Das Wasser ist kein eigenes Mesh mehr: jeder Voxel-Chunk baut seine Wasser-Fläche selbst (`_buildVoxelChunkWater`), nass je Zelle wo `_voxelSurfaceY < _waterLevelAt` — aus DERSELBEN Geometrie-Quelle wie das Terrain. Die Uferlinie ist damit der exakte Schnitt, per Konstruktion (das „Visual = Collision"-Gesetz, aufs Wasser angewandt); Schweben/Bleed/Verengungs-Naht sind strukturell unmöglich. 4 Wasser-Meshes (V9.43) → 1 vereintes Mesh (V9.49) → 0 getrennte Wasser-Modelle (V9.50). Design + Lernschlüsse: `docs/hydrosphere.md` §12–§14.
