...
|---|---|---|
| ✅ Stabiles Fundament | erreicht | CI-Gate mit 2545 Playtest-Invarianten + Audit-Strict, Chunk-Welt mit BVH-Triangle-Mesh-Physik (visual = collision), 120 fps |
...
| ✅ **Welle 14 — Bibliothek** | komplett (V8.58/V8.60/V8.61) — browsbarer „Bibliothek"-Tab + „Portal holen" (P1); der Spieler signiert eine Welt, „signiert von <Autor>" + W13 V2 (P2); fremde Welt-Manifeste exportieren/importieren — die Bibliothek wird ein wachsender Index (P3). Der KI-Übersetzer bleibt der Horizont. |
...
> **Stand V8.61**: die sieben Wachstumsringe der Ur-Tabelle unten sind **alle erledigt** — ebenso die Wellen 1-14 (Welten-Ultiversum, Hylomorphismus-Crafting, Co-Schöpfer-Kreis, Welt-Portal, Vibe-Pass, **Bibliothek**). **W14 (Bibliothek) ist mit Phase 1+2+3 komplett** (V8.58/V8.60/V8.61) — die Bibliothek von Alexandria steht: eine browsbare, signierbare, wachsende Welt-Registry. Der Stamm hat gehalten: eine Datei, ~28000 Zeilen, keine Re-Komplexifizierung. Die nächste Front ist **W7 (Compute-Sharing)** — der WebRTC-Mesh als verteilter Server-Layer; der KI-Übersetzer bleibt der Horizont innerhalb von W14. Der vollständige Plan steht in `docs/roadmap.md`. Die Tabelle unten bleibt als historischer Ur-Plan stehen.
