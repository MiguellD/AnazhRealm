...
| ⚠️ **V11 Mesh-Pool-Pattern — Hybrid-Stand in Three.js v160** | V11.0-a/b/c/d gebaut (33 Test-Invarianten grün), V11.0-d.2.fix Welt-Variations-Flakiness wurzel-geheilt, V11.0-d.fix.gras2 frischer instanceMatrix-Buffer pro acquire (Hybrid gegen Three.js v160 Stale-Buffer-Race). Aber Schöpfer-Browser-Audit zeigte: „nicht synergetisch wie zuvor" — V11 in v160 ist Hybrid-Workaround, kein voller Genie-Pfad. Vollendung kommt in V12 wenn r184-Upgrade + WebGL-Removal die Wurzel strukturell heilen. |
