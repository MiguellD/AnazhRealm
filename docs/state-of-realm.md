...
| 🟡 **Welle 14 — Bibliothek** | Phase 1 live (V8.58) — die `WORLD_REGISTRY` ist über einen „Bibliothek"-Tab browsbar, „Portal holen" legt einen Tor-Bauplan ins Inventar. Phase 2 (signierte Manifeste) + Phase 3 (fremde Welten empfangen) offen. Detail: `roadmap.md` §3. |
