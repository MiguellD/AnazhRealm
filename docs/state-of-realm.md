...
|---|---|---|
| ✅ Stabiles Fundament | erreicht | CI-Gate mit 2648 Playtest-Invarianten + Audit-Strict, Chunk-Welt mit BVH-Triangle-Mesh-Physik (visual = collision), 120 fps |
...
> **Stand V8.73**: die sieben Wachstumsringe der Ur-Tabelle unten sind **alle erledigt** — ebenso die Wellen 1-14 + W7 (Welten-Ultiversum, Hylomorphismus-Crafting, Co-Schöpfer-Kreis, Welt-Portal, Vibe-Pass, Bibliothek, Compute-Sharing), der KI-Übersetzer (V8.68/V8.69), das Untrusted-Welt-Tor (V8.70), der Auto-Vendor-Pfad (W15 — V8.71 Bündel-Pfad, V8.72 GitHub-Fetch) und W16 Phase 1 (V8.73 — die Mesh-Welt-Verteilung: eine vendorte Welt reist peer-to-peer). Der Stamm hat gehalten: eine Datei, ~31000 Zeilen, keine Re-Komplexifizierung. Die nächste Front ist der **Rest des Fremd-Engine-Bogens** — W16 Phase 2 (browsbarer Welt-Katalog) + die Multiplayer-Sub-Welten (W17), detailliert geplant in `docs/roadmap.md` §3. Die Tabelle unten bleibt als historischer Ur-Plan stehen.
