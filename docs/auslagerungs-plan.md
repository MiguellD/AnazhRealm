...
| **W-A4** | **a ✅ (10.07., V18.439)** schmiede gedockt (ε: 21 klinge_-Rezepte, 0 Stamm-Kontrollfluss, `gate:schmiede-contract`+`gate:nervensystem-schmiede`); **b ✅ (V18.440)** Hand-Render-Gestalt (fx.held.gripX als Vertrags-Daten, sharedGeom-Wrapper, LRU-Refs) · offen: **c** Portal-CSP-Umzug · Donor-Abschied geraet_schwert nach Schöpfer-Abnahme · Rüstung/Trank als Rezepte | „keine eigenen Werkzeuge“ (Dock ✅) |
