...
**Akzeptanz des Bogens**: nach V9.44-f sind die sechs Befunde geheilt, alle ~2966 Invarianten weiter grün, Audit-Strict 0, und die Datei trägt keine Kontrollfluss-Funktion über ~200 Zeilen mehr (Daten-Tabellen ausgenommen). Die Weiterentwicklung dockt danach an benannte Strukturen an, nicht an Monolithen.
