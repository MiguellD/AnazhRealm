...
| **`docs/wahrerguss.md`**               | **AKTIVER BOGEN · DER MASTER-PLAN (LEAD)** | **DER WAHRE GUSS** — der EINE Plan zum atemberaubenden Bauplan, der die drei Gesichter (FORM·PHYSIK·ANBLICK) vereint. Das EINE Gesetz: ein Bauplan ist kein Mesh, sondern ein GESETZ — Detail·Schönheit·Vielfalt·Leben sind AUSLESEWERTE von VIER geteilten Pässen (Substanz · Körper/Skelett · Grammatik-Tiefe · Detail-Pass), durch die JEDER Bauplan fließt; das Genom (T1–T6) reitet oben, der Richter (Ω-PHYSIS) garantiert, das Tor erzwingt die Fidelität (§4), das Auge richtet (Wand 1). Weg: Substanz zuerst (breitester Hebel), dann Körper (lebendiges Herz), dann Tor/Tiefe/Detail. **ZUERST** vor Werk-Fidelität / Bauplan-Erzeugung / Kreatur / Avatar / Material-Look / Bäume / Fels / Kristall / Gerät / Rüstung / Bauwerk / Variation / Grammatik. |
| **`docs/lebendiger-koerper-plan.md`**  | **AKTIVER SUB-BOGEN (KÖRPER)**             | DER LEBENDIGE KÖRPER — Form × AAA-Bewegung × Werkstatt-Anpassung vereint (System B von `wahrerguss`); die Maschinerie steht, die Arbeit sind die Qualitäts-/Erlebnis-Schichten. **ZUERST** vor Avatar-/Kreatur-Bewegung · Motion · IK · Körper-Editor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| **`docs/koerper-neuanlage-plan.md`**   | **AKTIVER SUB-BOGEN (AVATAR)**             | Die regel-basierte Körper-NEUANLAGE (autoritativ für System B / Avatar): merge/trennen = RELATION · `k` PRO-NAHT · Hände/Füße/Gesicht aus Landmark-Profilen. **ZUERST** vor Avatar-Haut/-Anatomie.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| **`docs/neues-kleid-plan.md`**         | **AKTIVER SUB-BOGEN (VEGETATION/FELS)**    | DAS NEUE KLEID — die Phytogenese der Hauptwelt: die gesetz-wahre Morphologie + Ökologie + Wald-Ferne aus der Schöpfer-Vorlage (phytogenesis v38, das Terrain-Portal) in die Voxelwelt — der Herz-Tausch in `_growTreeBlueprintRich` (die zwei Ausgänge parts+skeleton bleiben), Zingg/Wadell in `noiserock`, 8-Winkel-Impostor für die Ferne; Wellen K0–K6, zwei Recon-Karten fundiert. **ZUERST** vor Baum/Fels/Vegetation/Wald-LOD/Jahreszeit.                                                                                                                                                                                                                                                                                                                     |
| **`docs/paritaet-vollendung-plan.md`** | **AKTIVER SUB-BOGEN (STUDIO-PARITÄT)**     | DIE PARITÄTS-VOLLENDUNG — der Wellen-Plan W1–W8 zum vorab festgelegten DONE-Kriterium der Studio-Paritäts-Mission (Bild-Paar ununterscheidbar · Boot ≤3 s · null Fremd-Silhouetten · kein LOD-Pop): Wahrheits-Wände → Mess-Linsen → `_scatterRegion`-Zeit-Scheiben → Boot-Warm-Pfad+Ring-Boot-Fenster → Dither-Blende → Silhouetten+Paritäts-Verdikt → Vertrag Phase 1 (Fahrzeuge) → Schöpfer-Abnahme; plus die offenen Schöpfer-Entscheide E-A..E-G. **ZUERST** vor Arbeit an Boot/Scatter-Streaming/Foundry-LOD/Paritäts-Messung/Fahrzeug-Vertrag.                                                                                                                                                                                                                 |
| **`docs/archiv/wahrerbauplan.md`**     | **ARCHIVIERT · SEIN (RUND, NORMATIV)**     | Ω-PHYSIS — der Physik-Schiedsrichter (Schwerpunkt → Stabilität → Steifigkeit/Versagen → Hebel → Lastpfad → Leser → Grammatik → Werkstatt). Säule I–IV + Ω-B5 RUND; der Richter lebt im Code (`_stability`/`_failsUnderLoad`/`_swingDynamics`/`_loadPath`). Der RICHTER von `wahrerguss` (§6#5). **ZUERST** vor Physik / Stabilität / Kreatur-Körper.                                                                                                                                                                                                                                                                                                                                                                                                                 |
| **`docs/archiv/wahreranblick.md`**     | **ARCHIVIERT · ANBLICK-REFERENZ**          | Ω-OPSIS — jede Oberfläche ein Auslesewert der Welt (Boden · Bewuchs · Materialien · Form · Atmosphäre · Geometrie-Feinheit Ω-O1..O16) + die fünf Wände. Absorbiert als die Detailliste von `wahrerguss` System A (Substanz). **ZUERST** für die volle Pfeiler-Tiefe der Material-/Boden-/Bewuchs-Arbeit.                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| **`docs/roadmap.md`**                  | **DIE KARTE**                              | **§0 DIE ÜBERSICHT** (der Tisch — alles Offene auf einer Seite, Stand V18.382) + der Backlog vorwärts + **DIE GEMERKTEN FÄDEN** (§4: Lockstep Stufe 3 · KI-Symbiose · Zeit-Portal · VR · Wasser-Zwei-Naturen · …).                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
**EIN PLAN, EIN GESETZ:** `wahrerguss.md` ist die KONVERGENZ der drei alten Gesichter-Pläne
(`wahrerwuchs` · FORM, `archiv/wahrerbauplan` · PHYSIK, `wahreranblick` · ANBLICK), die sich
gegenseitig re-diagnostizierten. Sie sind dasselbe Gesetz — _jede Eigenschaft ist ein Auslesewert
der Wahrheit, gerechnet/gelesen, nie geraten/gemalt_ — jetzt als EINE Produktions-Kette: ein
Bauplan ist ein GESETZ (rekursive Grammatik → grober Käfig), das durch VIER geteilte Pässe
(Substanz · Körper · Grammatik-Tiefe · Detail) zum Werk wird; das Tor erzwingt die Fidelität,
der Richter (Ω-PHYSIS, headless) garantiert die Wahrheit, das Auge (Wand 1, augen-bound) richtet
den LOOK. Die Vision verankern `state-of-realm` + `das-lebendige-feld`.

**Frisch archiviert (03.07.2026 — Doc-Ordnung V18.382):** `engine-orchestrierung-plan.md` (VOLLENDET V18.353–.356, default-an — Phase A Draw-Call-Kollaps · B Frame-Budget-Scheduler · C Fixed-Timestep) und `goldstandard-mesh-plan.md` (GESCHLOSSEN V18.372 — die gemessene Naht-Entscheidung: same-LOD-Normale gefixt, cross-LOD für-nichts, Transvoxel = falsches Werkzeug für Streaming) → `archiv/`.
**Frisch archiviert (16.06.2026 — die Konvergenz):** `wahrerwuchs.md` + `wahreranblick.md` →
`archiv/` (ihre Iteration ist verarbeitet; das Genom-PRINZIP + die Substanz-Pfeiler leben jetzt in
`wahrerguss.md` als System C + System A, das Wichtige ist herausgezogen — die volle Tiefe bleibt
durchsuchbar). Der aktive Lead ist jetzt `wahrerguss.md` (DER MASTER-PLAN); `archiv/wahrerbauplan.md`
bleibt die NORMATIVE Physik-Referenz (der Richter im Code).
...
| `archiv/engine-orchestrierung-plan.md`     | Engine-Orchestrierung (VOLLENDET V18.353–.356, default-an) — Phasen A/B/C + die Wände + Linsen                                  | Frame-Scheduler · Render-Graph · Batching · fixed-timestep · Loop-Struktur |
| `archiv/goldstandard-mesh-plan.md`         | Die Naht-ENTSCHEIDUNG (GESCHLOSSEN V18.372, gemessen) — damit die Transvoxel-Frage nicht neu aufgerollt wird                    | Chunk-Naht · LOD-Naht · Transvoxel · „Sterne durch Berge"                  |
