...
| **`docs/wahrerwuchs.md`**           | **AKTIVER BOGEN · FORM (LEAD)** | Ω-GENESIS der Form — das Bauplan-GENOM: aus EINEM Seed × wenige Achsen die volle Palette (Moos → Mammutbaum). T1–T6 GEBAUT (Varianz); **§11 = DIE FIDELITÄT (die PRIORITÄT)** — der Katalog zeigte „kaum ein Upgrade": die Werke sind rohe Primitiv-Blobs, nur Tempel/Schwert haben Detail-Meshes; F1–F6 hebt jedes System auf Tempel/Schwert-Niveau. §10 = der Vertikal-Bogen (Platzierung), hinter §11. **ZUERST** vor Genom / Werk-Fidelität / Bäume / Fels / Kristall / Gerät / Kreatur / Bauwerk / Variation. |
