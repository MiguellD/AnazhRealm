...
> **Status:** P0 + P1a + P1b + **P2 GEBAUT** (Feld-Collider-Helfer + Kapsel-Character-Controller + Struktur-Kollision + **Feld-Raycast** — Default AN seit V18.325, A/B hinter `state.fieldPhysics`, Chat `feldphysik` → Ammo). Die Mechanik trägt (Linsen grün: walk-feel · structure · inertia · edge · raycast); das Profi-Bewegungs-Gefühl ist gegossen (V18.326–.327). **Nur noch P3 offen: Ammo physisch RAUS** — ein reiner Schnitt, kein Funktions-Verlust mehr (Ammo läuft seit V18.330 nur als A/B-Schatten). Der Box-Schicht-Detail (§5.3/§5.5/§6 für freie Wurf-Boxen) bleibt Spezifikation.
