...
**Du erbst eine sehr lebendige Welt.** **~2995 Playtest-Invarianten grün + 0 Audit-Strict-Failures**, ~35700 Zeilen in einer Datei, alles produktiv. (Der Playtest-Konsolen-Zähler driftet ±3–8 je Lauf — „Alle Invarianten OK" ist die Wahrheit, nicht die exakte Zahl.) Vor dem ersten Code-Block: `CLAUDE.md` V9.43-c lesen (die jüngste Welle) + den Schöpfer-Audit-Block ganz oben. Disziplin: parallel bauen + beweisen, nie das Funktionierende brechen, ehrliche kleine Schritte vor grossen Würfen.
