...
## Schnell-Lage (Stand 17.05.2026, V8.31)

**Du erbst eine sehr lebendige Welt**. **2035 Playtest-Invarianten grün + 0 Audit-Strict-Failures**, ~25600 Zeilen in einer Datei, alles produktiv. Die jüngste Session-Hälfte (V8.23 → V8.31) war eine **Atmosphäre-Tiefe-Welle (6.G4)** in fünf Schritten, jeder aus einem Schöpfer-Browser-Test:
...
**Empfohlene Sequenz nach V8.31**: die drei 6.G4-Polish-Punkte (Tauchen+Sneak, Schwimm-Animation, Wasser noch heterogener — siehe `roadmap.md` Zeile „W6.G4") → 11 V3 (Soul-Sync) → 11 ext. (Substanz-Rolle) → 12 (Welt-Portal) → 13 (Vibe-Pass) → 14 (Bibliothek) → 7 (Compute-Sharing).
