...
| Phase 2F.3 (offen) | 🔴 als nächstes | **Kreatur-Boosts via Konsumables** — apply_boost-Op auf Kreatur, Tränke trinken (analog Player). `creature.userData.boosts[]` Array, expiresAt-Cleanup im Tick. ~1 Session. |
