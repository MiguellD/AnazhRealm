...
| Phase 2E V2 (offen) | 🔴 später | **Proaktive Sprache** — Kreatur initiiert Chat-Output bei Events: Level-Up („Ich werde besser im Holz-Sammeln!"), Boost-Trinken („Der Trank kribbelt!"), Material-Mangel im Bring („Du hast kein Material für mich"). |
