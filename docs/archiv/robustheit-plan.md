...
**Status:** AKTIVER BOGEN (in den gigant-plan integriert 10.06.2026 als **Säule G8** + **Phase G** — die Treppe R0→R6). Konsolidiert aus dem Co-Creation-Dialog. Vereint die zwei Vorgänger-Entwürfe (Drei-Ringe + Selbst-Erweiterung) zu EINEM Bogen und schließt die Netz-Immunität, die beide zu kurz hielten. Setzt auf den GEMESSENEN Stand auf (Vibe-Pass W13/W14, Portal-iframe null-origin, `worlds/translated`, Wasser-CA-Gleichgewicht, ~3500 Invarianten).
...
- **R1 — der gedämpfte Kanal (M2)** — _offen_
- **R2 — die Irreversibilitäts-Wand (M3)** — _offen_
- **R3 — Lokalitäts-Härtung (M1)** — _offen_
- **R4 — Netz-Immunität (M4: Herkunftskette + Rückruf + Quarantäne)** — _offen_
- **R5 — das lebende Immunsystem (M5)** — _offen_
- **R6 — Selbst-Erweiterung (Capability-Inversion, der ANDERE Plan)** — bewusst FERN, nach R0–R5
