...
- `abschluss-plan.md` — DER ABSCHLUSS-PLAN (14.06., „alle offenen Punkte, ein Weg") —
  der Vorgänger, vom aktiven Bogen (Ω-PHYSIS + Ω-OPSIS) abgelöst. Backlog-Reste leben
...
| `eigene-physik-plan.md`             | DER DETERMINISMUS-BOGEN — die eigene voxel-native Physik (Ammo raus, Kollision feld-nativ; P0–P4)                                     | **VOLLENDET P0–P3 (V18.325–.331)** — Ammo physisch raus, der per-Chunk-BVH-Lauf-Freeze tot, der Boden deterministisch; **P4 (Replay/Lockstep) = eigener Folge-Bogen**, den der det. Boden erst öffnet     |
