...
Stand: V9.43-e (21.05.2026). Diese Doc trägt den **Plan vorwärts** — die Ring-Übersicht 0-17, was offen ist, die Meilenstein- und Risiko-Sicht. Die anderen Zeit-Ebenen: der aktuelle Stand + die Gotchas in `CLAUDE.md`, die volle Wellen-Chronik in `docs/handover.md`, die Vision in `docs/state-of-realm.md`.
...
- **Wasser-Politur-Rest** — V9.43-e gab dem Wasser Klang (Bach-Rauschen + Wasserfall-Donnern); offen bleibt nur kosmetische Mikro-Politur (See-Ufer-Schaum, Flow-Speed nach Gefälle — `docs/hydrosphere.md` §9 V9.43-e). Kein eigener Bogen, eine optionale Nicety.
