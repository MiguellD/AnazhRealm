...
Stand: **V14.8 (30.05.2026) — Terrain-Bogen „Die wahre Tiefe des Geländes" (epische Geomorphologie, V14.0–.8, Browser-Audit-getrieben).** Das Makro-Relief von uniform-spitz-alpin zu abwechslungsreich-wie-die-Erde: V14.0 Diagnose · V14.1 `cont0` · V14.2 thermische Erosion · V14.3 regionale Differenzierung · V14.4 echte Ebenen · V14.5 Harmonie-Heilung · V14.6 Fern-Heilung (Decke + Soft-Clamp + stale GPU-Mirror ab) · V14.7 Maßstab-Streckung (glatte λ2860-Hub-Oktave → Feature-Größe 176→464 m; terrainSteepness verdrahtet) · V14.8 gerichtete Uplift-Maske (der Hub wird RIDGED `(1−|noise|)²` λ3570 + Flow-Warp → lineare **Anden-Ketten**, Elongation 1,82→2,28). **Über den Bogen (gemessen): steil 26→0 %, Median 35→14,6°, sanft →33,6 %, Kohäsion →0,96, Ketten-Elongation →2,28, lange Flüsse 9–14, FPS 119.** Sechs Schöpfer-Browser-Audits eingearbeitet. Davor: V13-Wasser-Profi-Bogen (pausiert @ V13.14, Finish → V15) + V12-Genie-Bogen (r184 + WebGPU, 119 FPS) + V10.0-TSL-Bogen. Volle Wellen-Chronik in `docs/handover.md`.

**Nächste Welle: V14.9 — Browser-Audit-Bogen-Schluss.** Der Schöpfer prüft im Browser: Anden/Everest-Charakter, lineare Ketten über weite Distanzen, VIELFALT (Ketten ↔ Plateaus ↔ Ebenen), epische Felder, kohärente Seen/Flüsse. **Offener Vision-Trade (V14.8): eine EINZIGE Uplift-Oktave gibt entweder Ketten (ridged) ODER breite Plateaus (broad) — nicht beides; der V14.8-Hub wählte Ketten (Plateau 14,8→9,8 %).** Falls der Audit mehr Felder/Plateaus will: das Erde-treue REGIONALE Modell (breite Plateau-Regionen + Gebirgs-GÜRTEL an prozeduralen „Plattengrenzen", via einer Belt-Maske) — das V14.9-getriebene Refinement. Dann **V15 — Der Wasser-Finish** (Render-Sync-Wurzeln + Berg-Innenwasser + Sub-Region-Edit + ±1024-Wasser-Region) und **V16 — die lebendige Welt** (Pfeiler E/F/G). **Bogen-Lehre (V14.5–.8): wer die Terrain-Höhe/-Skala ändert, muss ALLE co-getuneten Annahmen nachziehen (surf-relative Schichten, Voxel-Decke, Density-Mirror Worker+GPU, Foundation-Tests surf-relativ, Tarn-See-Schwelle, Damm-Test-Ufer-Spot). Feature-Größe ∝ λ der dominanten Oktave; lineare Ketten = ridged-Oktave + Flow-Warp; Ketten UND Plateaus brauchen REGIONALE Differenzierung; die isotrope corrLen-Metrik unterschätzt anisotrope Ketten (darum die eigene Elongations-Metrik in diag-relief).**
...
| **V14 — Die wahre Tiefe des Geländes** 🔄 (V14.0–.8 ✅, V14.9 next) | **Epische Geomorphologie** (Schöpfer-Auftrag 30.05.2026: anden/everest, lange Flüsse, epische Felder, Vielfalt wie die Erde). Wurzel (empirisch + Code): Alpen-Miniatur-Maßstab — dominante Gebirgs-λ≈77 m, fehlende kontinentale Basis + Differenzierung + thermische Erosion. Heilt das Terrain UND die fragmentierte Hydrologie an EINER Wurzel. Detail §1.5. | V13.14 ✅ | **V14.0 ✅** Diagnose · **V14.1 ✅** `cont0` · **V14.2 ✅** thermische Erosion · **V14.3 ✅** regionale Differenzierung · **V14.4 ✅** echte Ebenen · **V14.5 ✅** Harmonie-Heilung · **V14.6 ✅** Fern-Heilung (Decke + Soft-Clamp + GPU-Mirror ab) · **V14.7 ✅** Maßstab-Streckung (λ2860-Hub → Feature-Größe 176→464 m; terrainSteepness verdrahtet) · **V14.8 ✅** gerichtete Uplift (ridged λ3570 + Flow-Warp → Anden-Ketten, Elongation 1,82→2,28; Trade: corrLen 464→336 anisotrop, Plateau →9,8 %) · **V14.9** Browser-Audit (+ ggf. regionale Plateau/Ketten-Koexistenz) | Über den Bogen: steil 26→0 %, Median 35→14,6°, sanft →33,6 %, Kohäsion →0,96, Ketten-Elongation →2,28, lange Flüsse 9–14, FPS 119. Determinismus-Bruch gewollt. |
...
| **V14.9** | **Browser-Audit-Bogen-Schluss**: Anden/Everest-Charakter, lineare Ketten über weite Distanzen, VIELFALT (Ketten↔Plateaus↔Ebenen), epische Felder, kohärente Seen/Flüsse. Falls mehr Felder gewünscht: das REGIONALE Modell (Plateau-Regionen + Gebirgs-Gürtel via Belt-Maske). Tarn-Konstanten (V9.51) ggf. nachziehen. | Bogen-Schluss + Plateau/Ketten-Balance |
