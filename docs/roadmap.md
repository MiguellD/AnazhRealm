...
| c | **V9.44-c** | Der Mesh-Router wird ein Dispatch-Table — `p2pHandleMessage`s 19-Branch-`if`-Kette → `_p2pMessageHandlers`-Tabelle + `_p2pHandle<Type>`-Methoden; der Router schrumpft auf einen ~5-Zeilen-Dispatcher. | ~1 Session | niedrig-mittel | 🔴 nächste Welle |
