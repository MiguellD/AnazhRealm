...
| **6.G — Welt-Sinne** (NEU, 13.05.2026) | **Phase 1 ✅ V7.73** (Inseln + Bäume kollidierbar, drei Dead-Code-DSL-Ops aktiviert) + **Phase 1.5 ✅ V7.74** (Schöpfer-Vision-Korrektur: Hylomorphismus-Unification — Bäume sind jetzt Compound-Architekturen über baum_eiche/baum_kiefer-Baupläne, Parallelcode gelöscht, Insel-Visual-Fix mit Vollkörper-Geometry + Lambert). Phase 2 offen: Schatten, Shader (Höhe-Tint, Wind, Glow), Sterne-Stabilisierung + Variation, Terrain-Höhlen+Überhänge+Klippen, Wasser als Material+Layer mit DSL-Ops | 7-9 Sessions, **Phase 1+1.5 erledigt**, Phase 2 = 5-6 Sessions | – (Phase 1) / 6.D (Phase 2) |
