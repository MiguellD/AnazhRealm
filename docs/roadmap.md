...
| **V11 Mesh-Pool** ✅ 4/5 | **Der wahre V11-Weg — Mesh-Pool-Pattern (V10.0-j.j-Bogen-Schluss)** (Schöpfer-Korrektur 27.05.2026). V10.0-j.j-Workaround entfernt, Profi-Pattern Genshin/BotW live, RECYCLE WIRKT empirisch (maxPoolSize=1 bei 48 echten Builds = 48× weniger Allokationen). | V10.0-j.j ✅ + D-Kern ✅ + Schöpfer-Korrektur | ✅ **V11.0-a** Pool-Foundation (`state._grassMeshPool` + 3 Methoden + GRASS_POOL_CAP=32 + LRU-Discard, 14 Inv) · ✅ **V11.0-b** Build-Pfad ruft `_acquireGrassMesh` (5 Inv) · ✅ **V11.0-c** Dispose-Pfad ruft `_releaseGrassMesh`, V10.0-j.j-Workaround-Kommentar ehrlich entfernt (7 Inv, „RECYCLE WIRKT") · ✅ **V11.0-d** Stress-Test 50 Spawn+Despawn-Zyklen, maxPoolSize=1 (7 Inv) · ⏳ **V11.0-e** Schöpfer-Browser-Audit AMD RDNA-3 (10-min Welt-Reise, Memory-Tab, FPS-Verlauf, visuelle Identität zu V10.0-j.j) | V10.0-Reflexion „Mesh-Memory > Race-Crashes" wird zu „Mesh-Pool > Mesh-Memory" — Bogen-Schluss-Disziplin verdrahtet. |
