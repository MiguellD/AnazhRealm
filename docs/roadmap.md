...
Stand: V9.72 (24.05.2026, **Welle C.2 erledigt** — Iso-Surface-Mesher für Wasser, naht-frei per Konstruktion, default-unsichtbar mit Toggle; C.3-C.5 folgen). Diese Doc trägt den **Plan vorwärts** — die Ring-Übersicht 0-17, was offen ist, die Meilenstein- und Risiko-Sicht. Die anderen Zeit-Ebenen: der aktuelle Stand + die Gotchas in `CLAUDE.md`, die volle Wellen-Chronik in `docs/handover.md`, die Vision in `docs/state-of-realm.md`.
