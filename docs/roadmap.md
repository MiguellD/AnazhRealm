...
**Nächste Welle: V13.9 — Sub-Region-Edit-Remesh** (nur die vom Carve/Fill berührte Zell-Sektion + ihre Mesh-Sektion neu, nicht der ganze 24×24×124-Chunk → Edit-Drops weg, + macht den Carve-Fluss frame-sauber). Danach **V13.10** LOD-Cross-Fade, **V13.11** Schöpfer-Browser-Audit; dann **V14 — die lebendige Welt** (Vision-Pfeiler E/F/G). Der volle V13-Plan steht in **§1.4**.
...
| **V13.9** ⏳ **next** | Sub-Region-Edit-Remesh: nur die vom Carve/Fill berührten Zellen + ihre Mesh-Sektion neu, nicht der ganze Chunk (macht den Carve-Fluss auch frame-sauber). | Edit-Drops, „ganzer Chunk neu" |
| **V13.10** | LOD-Cross-Fade: sanftes Überblenden zwischen Detailstufen statt hartem Pop. | „sauberer werden"-Pop |
| **V13.11** | Schöpfer-Browser-Audit RDNA-3: Wasser kohärent + fließend, kein Bluten/Höhlen-Blasen, smooth beim Streamen + Editieren. | Bogen-Schluss |
