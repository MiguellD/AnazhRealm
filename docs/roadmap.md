...
| **V11 Mesh-Pool** ⚠️ Hybrid | **Mesh-Pool-Pattern als Hybrid in Three.js v160 stabilisiert** — V11.0-a/b/c/d gebaut (33 Inv grün) + V11.0-d.2.fix Welt-Variations-Flakiness geheilt + V11.0-d.fix.gras2 Frischer instanceMatrix-Buffer pro acquire (Hybrid gegen v160 Stale-Buffer-Race). Aber Schöpfer-Browser-Audit zeigte: nicht volle Vollendung („nicht synergetisch wie zuvor"). | V10.0-j.j ✅ | ✅ V11.0-a/b/c/d Pool-API + Recycle · ✅ V11.0-d.2.fix · ✅ V11.0-d.fix.gras2 | V11 stabilisiert in v160. Vollendung kommt in V12 wenn r184-Upgrade + WebGL-Removal die Wurzel strukturell heilen (V11-Hybrid vermutlich obsolet). |
