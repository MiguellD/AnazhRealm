...
| W6.G4 | **Atmosphäre-Tiefe** (V8.27-V8.31) — Welt-unter-wandernder-Sonne (Hemisphere+Lambert+Fog), Welt-Atem-Vollendung (Sterne-als-Points, Terrain aus Affinität, Cel-Shading, Wind/Wolken/Wasser), Die lebendige Welt (Instanced-Gras, adaptives Wasser, Genesis-Plattform), Schnittstellen-Politur (Sterne-Tiefe, Avatar-Korrektur, Wasser-Wellen+Physik, Fog an Custom-Shader). | ✅ **live (V8.27-V8.31)** — 1976→2035 Invarianten. **Offene Polish-Punkte** (Schöpfer-Browser-Test V8.31): (a) **Tauchen** — unter die Wasseroberfläche, gekoppelt mit einer Slide/Sneak-Geste (Minecraft-Konvention: Shift = ducken/sneaken an Land, abtauchen im Wasser); braucht eine Sneak-Taste im Keybinding-System (6.C3) + Kamera-Tiefen-Logik. (b) **Schwimm-Animation** — der Avatar wirkt beim Schwimmen statisch gegen das bewegte Wasser; eine Schwimm-Pose + Wippen wäre der Polish. (c) Wasser noch heterogener (Domain-Warp ist da, evtl. Gerstner-Verschiebung für spitze Kämme). | 🟡 Kern live, 3 Polish-Punkte offen | 1-2 Sessions für die Polish-Punkte | W6.G3 |
...
**Summe verbleibend**: ~26-41 Arbeitstage in fokussierten Sessions. **Empfohlene Sequenz nach V8.32 (17.05.2026, Atmosphäre-Tiefe 6.G4 + Wasser-Politur komplett, 3 Polish-Punkte offen: Tauchen+Sneak, Schwimm-Animation, Wasser-Gerstner)**: W11 V3 → W11 ext. (Substanz-Rolle) → **W12 (Welt-Portal PoC mit three-fluid-fx)** → **W13 (Vibe-Pass)** → **W14 (Bibliothek)** → W7 (Compute-Sharing als verteilter Server-Layer für die Bibliothek). Logik: Polish ✅ (V8.13-V8.22) → Atmosphäre ✅ (V8.24+V8.25) → Disziplin-Polish ✅ (V8.26) → Welt-unter-wandernder-Sonne ✅ (V8.27) → Welt-Atem-Vollendung ✅ (V8.28) → Die lebendige Welt ✅ (V8.29 Instanced-Gras + adaptives Wasser + Genesis-Plattform) → Schnittstellen-Politur ✅ (V8.30 Sterne-Tiefe + Avatar-Korrektur + Wasser-Wellen + Wasser-Physik) → Multi-User-Tiefe (Peer ist echt) → Hylomorphismus-Vollausbau (Substanz-Rolle) → **Welt-Brücken (12-14, das größte Vision-Wort)** → Skalierung als Compute-Sharing-Layer.
