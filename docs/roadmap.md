...
| 5 | **W10 ext.** | vier weitere Affordances — je eine kleine Welle, räumliche Analyse + Welt-Reaktion, KEIN Form-Whitelist (W10b.2-Lehre). **`radiating` ✅ (V8.97)** + **`broadcasting` ✅ (V8.98)** + **Stärke-Politur ✅ (V8.99)** — die Affordance-Wirkung skaliert kontinuierlich mit der Substanz (`computeAffordanceStrength` = Tag-Überschuss × Qualität); man baut eine bessere Antenne durch Material/Form/Handwerk. Offen: balancing/lifting (erben die Stärke-Schicht automatisch). | ~1 Session je | 🟡 2/4 + Stärke-Politur live |
