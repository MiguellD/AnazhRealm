...
| 5 | **W10 ext.** | vier weitere Affordances — je eine kleine Welle, räumliche Analyse + Welt-Reaktion, KEIN Form-Whitelist (W10b.2-Lehre). **`radiating` ✅ live (V8.97)** — resonanz-strahlendes Compound, nahe ihm steigen awe+peace. **`broadcasting` ✅ live (V8.98)** — ein leitfähiger aufrechter Mast (Relais), verdoppelt die Reichweite eines nahen `radiating`-Strahlers (Affordances komponieren). Offen: balancing/lifting. | ~1 Session je | 🟡 2/4 (radiating + broadcasting live) |
