...
| W13 | **Vibe-Pass (Self-Sovereign Identity)** — Crypto-Keypair (ed25519, lokal generiert). Schöpfer signiert eigene Baupläne/Welten. Avatar-Identifier = Public-Key. Kein Coin/NFT-Hype, nur Authentizität. Welt-Memberships als signierte Records. Vorbedingung für Welt-Portale die Authentizität brauchen. | 🟡 **Phase 1 live (V8.54)** — Schlüssel-Grundlage: ed25519-Keypair (WebCrypto nativ), Sign/Verify-Primitive, globale localStorage-Persistenz (`anazh.vibePass`, nie im Welt-Save), sichtbare + sicherbare Identität im Spieler-Drawer, Genesis-Journal-Eintrag. **Offen**: Phase 2 (Bauplan-Signaturen), Phase 3 (Signatur-Prüfung in Multi-User / Welt-Tor / Portal-Manifest). | 4-6 Sessions Rest | W12 ✅ |
...
**Summe verbleibend**: ~20-31 Arbeitstage in fokussierten Sessions. **Empfohlene Sequenz nach V8.54 (W13 Phase 1 LIVE — die Schlüssel-Grundlage des Vibe-Pass steht)**: **W13 Phase 2 (Bauplan-Signaturen)** → **W13 Phase 3 (Signatur-Prüfung überall)** → **W14 (Bibliothek)** → W7 (Compute-Sharing als verteilter Server-Layer für die Bibliothek). Optional einschiebbar: W11 V4 (Voice-Sync, ~1 Session) oder eine kleine Affordance-Welle (10b). Logik: Atmosphäre ✅ → Multi-User-Tiefe ✅ (Peer ist sein echter Soul) → Hylomorphismus-Vollausbau ✅ (V8.35 — Rolle emergiert aus der Substanz) → Welt-Portal-Protokoll ✅ (W12 — das Tor trägt beide Richtungen) → **souveräne Identität (W13 — Phase 1 ✅, der Avatar hat einen Schlüssel)** → die Bibliothek (W14, fremde Welten) → Skalierung als Compute-Sharing-Layer.
