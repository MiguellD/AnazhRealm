...
**Welle A geschlossen**: das Wasser ist nicht mehr Dekoration. Der Spieler baut Damm → Aufstauen; bricht ab → Fließen; carvt Loch → Pfütze. Wasserfälle entstehen wo die echte Topologie (Worldgen + Edits + Bauten) sie ergibt — sekundäre Phänomene, keine prozedurale Schmierschicht. **Vor-Audit**: Schöpfer-Browser-Audit pendent, dann nächste Welle (Backlog).
