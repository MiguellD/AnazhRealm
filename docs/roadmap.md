...
- **Submarine-Detail — V9.60-c ✅ erledigt (23.05.2026, eigene Variation am Wassergrund nach Schöpfer-Befund „flach, uninteressant").** Riesen-Lehre Minecraft Aquifer / NMS Underwater: zwei Sub-Octaven (λ~330m ±3 m + λ~100m ±1 m) mit smoothstep-Tiefen-Maske ab 1.5..5.5 m unter Wasser. Ufer unberührt (keine Mini-Inseln), Tiefsee variabel (Hügel + Sediment). **Offen für V9.60-d (See-Fluss-Naht unsauber)**: Vision-Pfeiler Wasser↔Wille der Welle A, Hydrosphäre-Code-Schicht (Wasserfall-Übergänge zwischen Hochseen + Tiefland sauber rendern). Substantielle Welle.
