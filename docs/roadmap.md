...
| f | **V9.44-f** | Der Game-Loop bekommt Phasen-Struktur — `startEternalLoop` (696 Z.) Loop-Body in benannte Phasen-Methoden (`_loopPhysicsSync`/`_loopPlayerMovement`/`_loopCamera`/…), geteilte lokale Werte als explizite Parameter. Bewusst zuletzt; Browser-Test verpflichtend. | ~2 Sessions | mittel | 🔴 nächste Welle |
