...
- **Submarine-Biom-Dämpfung — V9.60-a ✅ erledigt (23.05.2026, visuelle Notbremse nach Schöpfer-Befund „viele biome scheinen aktuell unterwasser").** Wurzel: `waterLevel = heights[35-Perzentil]` → 46.3% Ozean per Definition; worldFieldAt-Biome (Lava/Magie/Wiese) leuchten durch die Wasser-Oberfläche durch. Erster Versuch (waterLevel-Perzentil 0.35→0.20) brach die V9.51-Tarn-Invariante (3 Systeme co-getuned). Zweiter Versuch (gewählt): in `_attachVoxelFieldColors` Biom-Schichten mit `biomeStrength`-Faktor multiplizieren, Crossfade −3..0 m. Stein + Sediment + Sand-Tint bleiben → Submarine-Bereich ruhiger einheitlicher Look. Lehre: visuelle Heilung VOR Wurzel-Bruch bei co-getuneten Konstanten. **Offen für V9.60-b**: strukturelle Hydrosphäre-Heilung (Befund 1 aus V9.58: Seen auf ähnlicher Höhe, keine langen Flüsse, See-Fluss-Naht) — substantielle Welle mit gekoppelten waterLevel + TARN + Hydrosphäre-Anpassungen, eigene Diagnose-Pass-Erweiterung nötig.
