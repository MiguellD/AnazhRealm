...
**Akzeptanz**: das Wasser liest sich als EIN Körper — keine gestapelten Sheets, kein toter See in der Ferne, der Fluss liegt in seiner Furche und mündet nahtlos. Playtest grün (V9.49 +~20 Invarianten netto). **Der Schöpfer-Browser-Audit steht aus** — wie bei jeder Wasser-Welle (V9.43-a..e): Headless prüft die Mechanik, das Schöpfer-Auge die Ästhetik. Die Physik (`state.waterLevel`, `_hydroWaterLevelAt`-Auftrieb) blieb unverändert — sie liest Daten, kein Mesh.
