...
| **V13.5** ⏳ **next** | Sub-Region-Edit-Remesh: nur die vom Carve/Fill berührten Zellen + ihre Mesh-Sektion neu, nicht der ganze Chunk. | Edit-Drops, „ganzer Chunk neu" |
| **V13.6** | Wasser-Shader-Glanz: Tiefen-Schaum (Depth-Buffer), Gerstner-Ripples (Vertex), Reflexion/Refraktion auf der billigen flachen Fläche. | Visuelle Tiefe wie die Profis |
