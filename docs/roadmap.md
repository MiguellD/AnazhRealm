...
Stand: **V14.7 (30.05.2026) — Terrain-Bogen „Die wahre Tiefe des Geländes" (epische Geomorphologie, V14.0–.7, Browser-Audit-getrieben).** Das Makro-Relief von uniform-spitz-alpin zu abwechslungsreich-wie-die-Erde: V14.0 Diagnose · V14.1 kontinentale Basis `cont0` · V14.2 thermische Erosion · V14.3 regionale Differenzierung · V14.4 echte Ebenen + See-Queue · V14.5 Harmonie-Heilung (Höhlen-Decke) · V14.6 Fern-Heilung (Decke dimY 124→136 + Soft-Clamp + stale GPU-Mirror ab) · V14.7 Maßstab-Streckung (eine glatte asymmetrische λ2860-Hub-Oktave `upland` macht die DOMINANTE Skala die GRÖSSTE → Feature-Größe **176→464 m kontinental**; `terrainSteepness` verdrahtet, tect-Kommentar-Lüge geheilt). **Über den Bogen (gemessen): Feature-Größe 112→464 m, steil 26→0 %, Median 35→14,6°, sanft 6,7→33,6 %, Plateau 2,7→14,8 %, Kohäsion →0,95, 12 lange Flüsse, FPS 119.** Fünf Schöpfer-Browser-Audits eingearbeitet. Davor: V13-Wasser-Profi-Bogen (pausiert @ V13.14, Finish → V15) + V12-Genie-Bogen (r184 + WebGPU, 119 FPS) + V10.0-TSL-Bogen. Volle Wellen-Chronik in `docs/handover.md`.

**Nächste Welle: V14.8 — Gerichtete Uplift-Maske (Anden-Ketten).** Lineare/kurvige Gebirgsketten statt isotropes Noise → lange Züge über weite Distanzen (Hochland-Kohäsion ↑↑, „über weite strecken aufbauend"). Danach **V14.9** (Browser-Audit-Bogen-Schluss). Dann **V15 — Der Wasser-Finish** (die drei Render-Sync-Wurzeln + Berg-Innenwasser + Sub-Region-Edit + die ±1024-Wasser-Region, gegen die neue Topologie) und **V16 — die lebendige Welt** (Pfeiler E/F/G). Der volle V14-Plan steht in **§1.5**, der Bogen-Fortschritt in der §1.1-Tabelle. **Bogen-Lehre (V14.5–.7): wer die Terrain-HÖHE/-Skala ändert, muss ALLE höhen-co-getuneten Annahmen nachziehen — die surf-relativen Schichten, die Voxel-DECKE, jeden Density-Mirror (Worker + GPU-WGSL) UND die Foundation-Tests (surf-relativ statt absolute Y-Bänder). Feature-Größe ∝ Wellenlänge der dominanten Oktave (glatt + asymmetrisch baut Hochland ohne Flutung), NICHT Amplitude. Decken-Diagnose radial bis > λ (7100 m), kein Spawn-Fenster. EHRLICH: der V14.7-Hub hebt die Median-Surface ~20→50 m (Hochplateau-Welt).**
...
| **V14 — Die wahre Tiefe des Geländes** 🔄 (V14.0–.7 ✅, V14.8 next) | **Epische Geomorphologie** (Schöpfer-Auftrag 30.05.2026: anden/everest, lange Flüsse, epische Felder, Vielfalt wie die Erde). Wurzel (empirisch + Code): Alpen-Miniatur-Maßstab — dominante Gebirgs-λ≈77 m, fehlende kontinentale Basis + Differenzierung + thermische Erosion. Heilt das Terrain UND die fragmentierte Hydrologie an EINER Wurzel. Detail §1.5. | V13.14 ✅ | **V14.0 ✅** Diagnose · **V14.1 ✅** kontinentale Basis `cont0` · **V14.2 ✅** thermische Erosion (steil 29→13 %) · **V14.3 ✅** regionale Differenzierung · **V14.4 ✅** echte Ebenen + See-Queue · **V14.5 ✅** Harmonie-Heilung (Höhlen-Decke surf−6→surf−16) · **V14.6 ✅** Fern-Heilung (Decke dimY 124→136 + Soft-Clamp + stale GPU-Mirror ab) · **V14.7 ✅** Maßstab-Streckung (glatte asym. λ2860-Hub-Oktave → Feature-Größe 176→464 m kontinental; terrainSteepness verdrahtet) · **V14.8** Uplift-Maske (Anden-Ketten) · **V14.9** Browser-Audit | Über den Bogen: Feature-Größe 112→464 m, steil 26→0 %, Median 35→14,6°, sanft →33,6 %, Plateau →14,8 %, Kohäsion →0,95, 12 lange Flüsse, FPS 119. Determinismus-Bruch gewollt. |
