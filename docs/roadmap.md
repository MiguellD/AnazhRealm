...
| 5 | **W10 ext.** | vier weitere Affordances — je eine kleine Welle, räumliche Analyse + Welt-Reaktion, KEIN Form-Whitelist (W10b.2-Lehre). **`radiating` ✅ (V8.97)** + **`broadcasting` ✅ (V8.98)** + **Stärke-Politur ✅ (V8.99)** (die Wirkung skaliert mit der Substanz) + **`balancing` ✅ (V9.00)** — eine gründende Form (breit/bodenlastig/schwer), nahe ihr sinkt chaos. Offen: `lifting` (physik-gekoppelt, eigene Welle). | ~1 Session je | 🟡 3/4 (radiating + broadcasting + balancing live) |
