...
Stand: 18.05.2026 (laufend aktualisiert; ursprünglich bei V8.52 geschrieben — die Umsetzungs-Noten unten reichen bis V8.77). Diese Doku ist **keine Implementierungs-Spec**, sondern ein **Vision-Anker**. Sie hält die Frage offen: was wird AnazhRealm, wenn der Spieler nicht nur Welten innerhalb einer Engine baut, sondern durch Welten zwischen Engines geht?
...
Stand V8.77 — die Sequenz bis zur Bibliothek + der Fremd-Engine-Bogen (W15 + W16 + W17 komplett):
