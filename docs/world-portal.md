...
| **14** | **Bibliothek** (Welt-Registry + Browse-UI + Auto-Portal-Bauplan) | 🟡 **Phase 1+2 live (V8.58/V8.60)** — browsbarer „Bibliothek"-Tab + „Portal holen" (P1), signierte Welt-Manifeste + „signiert von <Autor>" + W13 V2 (das Schaffen reist mit) (P2); P3 (fremde Welten empfangen) offen, Plan in `roadmap.md` §3 |
