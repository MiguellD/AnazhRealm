...
## Aktueller Stand (V9.52-d, 23.05.2026)
...
**Letzte Arbeit — Playtest-Pflege-Bogen Sub-Welle d (V9.52-d):** Band 3 ist extrahiert. Von der ehemaligen 31 574-Zeilen-IIFE sind jetzt die ersten ~22 256 Zeilen der `### Invarianten`-Sektion (145 Original-Sektionen) in 31 benannte Funktionen aufgeteilt — knapp **drei Viertel der Test-Datei** ist strukturiert. Sub-Welle d brachte 8 weitere Band-Funktionen (Welle 6.X.1-X.5 Audit + 6.G3/G4 Atmosphäre + V8.24-V8.49 Politur + W12-W14 Welt-Portal-Bogen + KI-Übersetzer + V8.70-72 Untrusted-Tor/Vendor + späte 6.X.4-Fixes, ~6580 Zeilen, 50 Sektionen): `checkBandWelle6XAudit` (4 Audit-Sektionen), `checkBandWelle6G3Lebendigkeit` (6.G3 + V2), `checkBandWelle6G4Atmosphere` (V8.26 Polish + V8.27 Sonne + V8.28 Welt-Atem + V8.29-V8.33 lebendige Welt/Tauchen), `checkBandV8SoulRoleAndWorkshop` (V8.34 Soul-Sync + V8.35 Substanz-Rolle + V8.36 Browser-Fixes + V8.37-V8.39 Werkstatt+Werkzeuge), `checkBandW12WorldPortal` (W12 Phase 1+2+3 — der ganze Welt-Portal-Bogen, 1190 L), `checkBandW13W14VibePassLibrary` (W13 Vibe-Pass + W14 Bibliothek), `checkBandTranslatorAndUntrusted` (KI-Übersetzer P1/P2 + V8.70 Sandbox-Tor + V8.71/72 W15 Vendor/GitHub-Fetch), `checkBandV8LatePolishAnd6XContinued` (V8.40+41+46+48+49 + zwei späte 6.X.4-Audit-Fixes). Je 498-1190 Zeilen. Plan-treu zu §5. Mechanisches `/tmp/extract-band3-d.cjs`-Skript (direkte Adaption des c-Skripts mit neuer Band-Tabelle). Verhaltens-identisch bewiesen (3060-Invarianten-Satz bit-identisch, nur Drift-Bänder: 3 perf-ms-Werte + 2 Worldgen-Count-Drifts). Datei: 30 832 → 30 415 (−417 netto). Orchestrator (Zeile ~21825) führt jetzt 3 a-Calls + 11 b-Calls + 8 c-Calls + 8 d-Calls. Sub-Welle e zieht die End-Sektionen (Welle 6.H 2B.2 .. Welle 9/10 + V8.00-V8.07 CAD + V7.x LLM + Ring 3-6 + UI V1/V2) nach, Sub-Welle f der Helfer-Durchzug + Politur. Voller Plan: `docs/playtest-hygiene.md`.
...
**Nächste Welle:** Playtest-Pflege Sub-Welle e — Band 4 (die End-Sektionen ab Welle 6.H Phase 2B.2 bis Datei-Ende: Welle 6.H 2D/2E/2F + Welle 6.B CAD + V8.00-V8.07 + Welle 9a-d + Welle 10a/b + V7.94-V7.98 LLM + Ring 3-6 + UI V1/V2, ~55 Sektionen, Zeilen ~22257 bis ~31040). Das d-Skript ist die Vorlage. Daneben offen + auf den Schöpfer-Browser-Audit wartend: V9.50 + V9.51 (jede Wasser-Welle wird im Browser geprüft). Weiter dahinter: die offenen Roadmap-Kandidaten (`docs/roadmap.md` §1 — System-Kopplungen ab „Wasser ↔ Spieler-Wille" als nächste Vision-Vertiefung, Crafting-Tiefe, ein zweiter Code-Hygiene-Bogen).
