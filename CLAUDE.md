...
**Nächste Welle:** offen — `docs/roadmap.md` §1 listet die Kandidaten (Crafting-Tiefe, der Playtest-Pflege-Bogen, ein zweiter Code-Hygiene-Bogen, ein vereintes Wasser-System); keine ist terminiert. Ehrlich offen — die fluviale Inzision carvt einen Kanal DURCH ein breites Becken, leert es aber nicht restlos (der Becken-Boden bleibt ein kleinerer See — geomorphologisch korrekt; `docs/hydrosphere.md` §10b).
