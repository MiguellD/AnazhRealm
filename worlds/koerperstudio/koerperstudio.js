...
const SKIN_TONES=window.__koerperCore.SKIN_TONES;   // KONVERGENZ II: die haut-palette wohnt im gesetzbuch (koerper-core.SKIN_TONES) -- EINE quelle, kein zwilling
...
const __MK=window.__koerperCore.MATERIAL_KLASSEN;   /* KONVERGENZ II: die klassen-farben wohnen im gesetzbuch */ const matLips=new THREE.MeshPhysicalMaterial({color:__MK.lips.c,roughness:0.4,clearcoat:0.8,clearcoatRoughness:0.2});const matEye=new THREE.MeshPhysicalMaterial({color:__MK.eye.c,roughness:0.05,clearcoat:1.0});const matIris=new THREE.MeshStandardMaterial({color:__MK.iris.c,roughness:0.1});const matCornea=new THREE.MeshPhysicalMaterial({color:0xffffff,roughness:0,transparent:true,opacity:0.05,ior:1.38,clearcoat:1.0});const matSocket=new THREE.MeshStandardMaterial({color:__MK.socket.c,roughness:0.6});const matDark=new THREE.MeshBasicMaterial({color:__MK.dark.c});const matJoint=new THREE.MeshStandardMaterial({color:__MK.joint.c,roughness:0.6});const matShadow=new THREE.MeshStandardMaterial({color:__MK.shadow.c,roughness:0.7});
...
const HAIR_COLORS=window.__koerperCore.HAIR_COLORS;   // KONVERGENZ II: die haar-palette wohnt im gesetzbuch (koerper-core.HAIR_COLORS)
var _hairMatCache={};
...
const CLOTH_COLORS=window.__koerperCore.CLOTH_COLORS;   // KONVERGENZ II: die stoff-palette wohnt im gesetzbuch (koerper-core.CLOTH_COLORS) -- EINE quelle, kein zwilling
